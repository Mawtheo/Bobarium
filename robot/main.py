        ...
        while True:
            ...
            if "GET" in requete.decode():
                ...
                if "/avancer" in url_part:
                    ...
                    distance()
                    json_reponse = {"commande": "distance", "data": None}
                elif "/bobarium" in url_part:
                    bobarium()
                    json_reponse = {"commande": "bobarium", "data": None}
                elif "/angle_robot" in url_part:
                    angle_robot()
                    json_reponse = {"commande": "angle_robot", "data": None}
                elif "/angle_roue" in url_part:
                    angle_roue()
                    json_reponse = {"commande": "angle_roue", "data": None}
                else:
